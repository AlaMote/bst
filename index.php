...
<div id="controls">
    ...
    <label for="addNode">Додати вузол</label><br>
    <input type="text" id="addNode" name="addNode"><br>
    <input type="button" id="addNodeBut" value="Додати">
...
<div id="popUpMenu">
    <input type="button" id="delNode" value="Видалити вузол"><br>
    <input type="button" id="changeNode" value="Змінити вузол"><br>
...
<img src="./res/sets_1.png" id="show_controls" alt="Показати налаштування">
<img src="./res/sort.png" id="sort" alt="Сортувати" width="20">
